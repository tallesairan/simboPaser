    ...
    <header id="header">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-3">
            <?php get_template_part('partials/_phones'); ?>
          </div>
        </div>
      </div>
            ...
            <div class="col-12">
              <nav id="navbar" class="navbar  navbar-expand-lg">
                <div class="navbar-header">
                  <button type="button" class="navbar-toggle offcanvas-toggle pull-right d-block d-sm-none" data-toggle="offcanvas" data-target="#js-bootstrap-offcanvas" style="float:left;">
