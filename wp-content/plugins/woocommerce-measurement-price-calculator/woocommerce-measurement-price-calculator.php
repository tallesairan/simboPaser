...
SV_WC_Framework_Bootstrap::instance()->register_plugin( '4.8.0', __( 'WooCommerce Measurement Price Calculator', 'woocommerce-measurement-price-calculator' ), __FILE__, 'init_woocommerce_measurement_price_calculator', array(
